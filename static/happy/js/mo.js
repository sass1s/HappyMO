    ...
    /******/ ([
                ...
                Helpers.prototype.mergeUnits = function(start, end, key) {
                    if (!end.isStrict && start.isStrict) {
                        ...
                        if (end.unit !== start.unit) {
                            ...
                            return this.warn("Two different units were specified on \"" + key + "\" delta property, mo 路 js will fallback to end \"" + end.unit + "\" unit ");
                        }
                    }
                };
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var Module = function () {
                ...
                /*
                 Method to parse values inside 鈭�.
                 @private
            ...
            var Shape = function (_Tunable) {
                ...
                Shape.prototype._declareDefaults = function _declareDefaults() {
                    ...
                    this._defaults = {
                        ...
                        shape: 'circle',
                        // 鈭� :: Possible values: [color name, rgb, rgba, hex]
                        stroke: 'transparent',
                        // 鈭� :: Possible values: [ 0..1 ]
                        strokeOpacity: 1,
                        // Possible values: ['butt' | 'round' | 'square']
                        strokeLinecap: '',
                        // 鈭� :: Possible values: [ number ]
                        strokeWidth: 2,
                        // 鈭� :: Units :: Possible values: [ number, string ]
                        strokeDasharray: 0,
                        // 鈭� :: Units :: Possible values: [ number, string ]
                        strokeDashoffset: 0,
                        // 鈭� :: Possible values: [color name, rgb, rgba, hex]
                        ...
                        // 鈭� :: Possible values: [ number ]
                        scale: 1,
                        // 鈭� :: Possible values: [ number ] Fallbacks to `scale`.
                        scaleX: null,
                        // 鈭� :: Possible values: [ number ] Fallbacks to `scale`.
                        scaleY: null,
                        // 鈭� :: Possible values: [ number, string ]
                        origin: '50% 50%',
                        // 鈭� :: Possible values: [ 0..1 ]
                        opacity: 1,
                        // 鈭� :: Units :: Possible values: [ number, string ]
                    ...
                    if (!_h2.default.isTweenProp(key) && !this._nonMergeProps[key] && !isBoolean) {
                        ...
                        if (this._isDelta(endValue)) {
                            ...
                            if (this._isDelta(startValue)) {
                                ...
                                // if both start and end value are not 鈭� - make 鈭�
                            } else {
                                var _ref2;
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var Tween = function (_Module) {
                ...
                Tween.prototype._declareDefaults = function _declareDefaults() {
                    // DEFAULTS
                    this._defaults = {
                        /* duration of the tween [0..鈭瀅 */
                        duration: 350,
                        /* delay of the tween [-鈭�..鈭瀅 */
                        delay: 0,
                        /* repeat of the tween [0..鈭瀅, means how much to
                         repeat the tween regardless first run,
                         for instance repeat: 2 will make the tween run 3 times */
                        repeat: 0,
                        /* speed of playback [0..鈭瀅, speed that is less then 1
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            /* WEBPACK VAR INJECTION */(function(global) {var BezierEasing, bezierEasing, h,
                ...
                /**
                 * Copyright (c) 2014 Ga毛tan Renaudeau http://goo.gl/El3k7u
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var ShapeSwirl = function (_Shape) {
                ...
                ShapeSwirl.prototype._declareDefaults = function _declareDefaults() {
                    ...
                    /* 鈭� :: [number > 0] :: Degree size of the sinusoidal path. */
                    this._defaults.swirlSize = 10;
                    /* 鈭� :: [number > 0] :: Frequency of the sinusoidal path. */
                    this._defaults.swirlFrequency = 3;
                    /* 鈭� :: [number > 0] :: Sinusoidal path length scale. */
                    this._defaults.pathScale = 1;
                    /* 鈭� :: [number] :: Degree shift for the sinusoidal path. */
                    this._defaults.degreeShift = 0;
                    /* 鈭� :: [number] :: Radius of the shape. */
            ...
            var Burst = function (_Tunable) {
                ...
                Burst.prototype._declareDefaults = function _declareDefaults() {
                    this._defaults = {
                        ...
                        degree: 360,
                        /* 鈭� :: [number > 0] :: Radius of the Burst. */
                        radius: { 0: 50 },
                        /* 鈭� :: [number > 0] :: X radius of the Burst. */
                        radiusX: null,
                        /* 鈭� :: [number > 0] :: Y radius of the Burst. */
                        radiusY: null,
                ...
                /*
                 Method to get radius from 鈭� or plain property.
                 @private
                 @param {String} Key name.
